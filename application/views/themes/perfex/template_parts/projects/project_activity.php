    ...
    <?php foreach($activity as $activity) { ?>
        <div class="feed-item">
            ...
            <?php } else if($activity['contact_id'] != 0){ ?>
                <img src="<?php echo e(contact_profile_image_url($activity['contact_id'])); ?>" class="client-profile-image-small pull-left mright10">
            <?php } ?>
            <div class="media-body">
                <div class="display-block">
                    <p class="mtop5 no-mbot">
                        <?php echo $fullname . ' - <b>'.e($activity['description']).'</b>'; ?>
                    </p>
