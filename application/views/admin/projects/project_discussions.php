...
<h3 class="tw-font-semibold tw-text-lg tw-text-neutral-700 tw-mt-0"><?php echo e($discussion->subject); ?></h3>

<div class="panel_s">
    <div class="panel-body">
        <p class="no-margin tw-text-neutral-700"><?php echo e(_l('project_discussion_posted_on', _d($discussion->datecreated))); ?></p>
